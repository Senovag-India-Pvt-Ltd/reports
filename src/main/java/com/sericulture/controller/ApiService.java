...
//                String finalapiurl = "http://localhost:8013/dbt/v1/sanctionOrderWorkOrderAcknowledgement/getReelingShedSanctionDetails";
    ...
    public SanctionOrder fetchDataFromRearingEquipmentSS(CheckInspectionStatusRequest requestDto)
            throws JsonProcessingException {

        String finalapiurl = dbtApiUrl + "sanctionOrderWorkOrderAcknowledgement/getRearingEquipmentSilkSamagraSanctionDetails";

//                String finalapiurl = "http://localhost:8013/dbt/v1/sanctionOrderWorkOrderAcknowledgement/getRearingEquipmentSilkSamagraSanctionDetails";
    ...
    public SanctionOrder fetchDataFromPrivateChawkiSanction(CheckInspectionStatusRequest requestDto)
            throws JsonProcessingException {

        String finalapiurl = dbtApiUrl + "sanctionOrderWorkOrderAcknowledgement/getRegisteredPrivateChawkiSanctionDetails";

//                String finalapiurl = "http://localhost:8013/dbt/v1/sanctionOrderWorkOrderAcknowledgement/getRegisteredPrivateChawkiSanctionDetails";
...
//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getFarmerSanctionForRHConstructionSSDetails";
    ...
    public SanctionOrder fetchDataFromSanctionLowCostShedToPermanentRearingHouseSDP(SanctionOrderPrintRequest requestDto) throws JsonProcessingException {

//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getFarmerSanctionForRHConstructionSDPDetails";


        String finalapiurl = dbtApiUrl +"sanctionOrderWorkOrderAcknowledgement/getFarmerSanctionForRHConstructionSDPDetails";
    ...
    public SanctionOrder fetchDataFromSanctionRHSDPLowCostShed(SanctionOrderPrintRequest requestDto) throws JsonProcessingException {

//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getFarmerSanctionForRHSDPLowCostShedDetails";


        String finalapiurl = dbtApiUrl +"sanctionOrderWorkOrderAcknowledgement/getFarmerSanctionForRHSDPLowCostShedDetails";
...
//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getAdoptingBoilerSanctionDetails";
    ...
    public SanctionOrder fetchDataFromSanctionMERM(SanctionOrderPrintRequest requestDto) throws JsonProcessingException {

//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getMermSanctionOrderDetails";


        String finalapiurl = dbtApiUrl +"sanctionOrderWorkOrderAcknowledgement/getMermSanctionOrderDetails";
...
//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getSolarWaterHeaterWorkOrderDetails";
    ...
    public SanctionOrder fetchDataFromRearingEquipmentSelection(SanctionOrderPrintRequest requestDto) throws JsonProcessingException {
...
//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getRearingEquipmentWorkOrderDetails";
    ...
    public SanctionOrder fetchDataFromSanctionCRCSelection(SanctionOrderPrintRequest requestDto) throws JsonProcessingException {

//        String finalapiurl = "http://localhost:8013/dbt/v1/" + "sanctionOrderWorkOrderAcknowledgement/getRegisteredPrivateChawkiWorkOrderDetails";


        String finalapiurl = dbtApiUrl +"sanctionOrderWorkOrderAcknowledgement/getRegisteredPrivateChawkiWorkOrderDetails";
