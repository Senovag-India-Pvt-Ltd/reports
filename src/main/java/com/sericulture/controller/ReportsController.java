...
// ✅ Clean formatted date for sanction order
        ...
        response.setHeader1("ಮೈಸೂರು  ಬಿತ್ತನೆ  ವಲಯದ  ರೇಷ್ಮೆ   ಬೆಳೆಗಾರರಿಗೆ  ವಿತರಿಸಬೇಕಾದ  ಬೋನಸ್  ಮೊತ್ತ     ರೂ. " +apiResponse.getContent().get(0).getTotalSchemeAmount() + "  ಗಳಿಗೆ \n" +
                ...
                "            \n"+
                "2) ರೇಷ್ಮೆ    ಆಭಿವೃದ್ಧಿ   ಆಯುಕ್ತರು  ಹಾಗೂ  ರೇಷ್ಮೆ   ನಿರ್ದೇಶಕರು , ಬೆ೦ಗಳೂರು ಇವರ ಸುತ್ತೋಲೆ  \n" +
                "            \n"+
                ...
                "            \n"+
                "4) ರೇಷ್ಮೆ  ಉಪ ನಿರ್ದೇಶಕರು , "+apiResponse.getContent().get(0).getLoggedinUserTalukName() + " ರವರ  ಜ್ಞಾಪನ  ಪತ್ರದ   \n" +
                "            \n"+
...
// ✅ Clean formatted date for sanction order
        ...
        response.setHeader1(  apiResponse.getContent().get(0).getFinancialYear() +  "   ನೇ   ಸಾಲಿನಲ್ಲಿ    ಉತ್ಪಾದಕತೆ    ಮತ್ತು      ಗುಣಮಟ್ಟ     ಅಧಾರದ   ಪ್ರೋತ್ಸಾಹಧನ  ಬಾಬ್ತು      ರೂ.  " +apiResponse.getContent().get(0).getTotalSchemeAmount() + "   ಗಳಿಗೆ\n" +
                "            \n"+
                "ಮ೦ಜೂರು   ಮಾಡುವ   ಕುರಿತು.\n" +
                "            \n"+
                "1) ಸರ್ಕಾರದ    ಆದೇಶ    ಸಂಖ್ಯೆ  : " +apiResponse.getContent().get(0).getAdmGovtOrder() + "  ದಿನಾಂಕ :  " + admGovtDate  + "\n" +
                "            \n"+
                "2) ರೇಷ್ಮೆ    ಆಭಿವೃದ್ಧಿ    ಆಯುಕ್ತರು   ಹಾಗೂ   ರೇಷ್ಮೆ   ನಿರ್ದೇಶಕರು , ಬೆ೦ಗಳೂರು   ಇವರ  ಸುತ್ತೋಲೆ   ಸಂಖ್ಯೆ  : \n" +
                "            \n"+
                "     " + apiResponse.getContent().get(0).getSchemeCircularNo() + "   ದಿನಾಂಕ :  " +schemeCircularDate  + " \n" +
                "            \n"+
                "3) ರೇಷ್ಮೆ    ಉಪ ನಿರ್ದೇಶಕರು,  " +apiResponse.getContent().get(0).getLoggedinUserTalukName() + "  ರವರ   ಜ್ಞಾಪನ   ಪತ್ರದ  ಸಂಖ್ಯೆ   :  " +apiResponse.getContent().get(0).getSReleaseNo() + "\n" +
                "            \n"+
                "     ದಿನಾಂಕ : " +sReleaseDate + " \n" +
                "            \n"+
                ...
                "            \n"+
                "            \n"+
                apiResponse.getContent().get(0).getFinancialYear() +"   ನೇ   ಸಾಲಿನಲ್ಲಿ     ನಿರಂತರ   ಬಿತ್ತನೆ   ಗೂಡುಗಳನ್ನು     ಉತ್ಪಾದಿಸಿ  ಸರಬರಾಜು   ಮಾಡುವ   ಉದ್ದೇಶದಿ೦ದ\n" +
                "            \n"+
                "ಸರ್ಕಾರವು   ಸರ್ಕಾರಿ   ರೇಷ್ಮೆ    ಗೂಡಿನ   ಮಾರುಕಟ್ಟೆಗಳಲ್ಲಿ     ವಹಿವಾಟಾಗುವ   ಬಿತ್ತನೆ   ಗೂಡುಗಳಿಗೆ   ಉತ್ಪಾದಕತೆ   ಮತ್ತು     \n" +
                "            \n"+
                 "ಗುಣಮಟ್ಟ      ಅಧರಿಸಿ    ಪ್ರತಿ    ಕೆ.ಜಿ.ಗೆ    ರೂ.   " +apiResponse.getContent().get(0).getPerKgRate() + " /- ರಂತೆ   ಪ್ರೋತ್ಸಾಹಧ ನೀಡಲು    ಉದ್ದೇಶಿಸಿ\n " +
                "        \n "+
                "ಉಲ್ಲೇಖ (1) ಮತ್ತು     (2) ರಲ್ಲಿ    ಅದೇಶಿಸಿರುತ್ತಾರೆ.\n" +
                "            \n"+
                "            \n"+
                "      ಉಲ್ಲೇಖ (1) ಮತ್ತು      (2) ರಲ್ಲಿ      ಈ    ಕಾರ್ಯಕ್ರಮದ    ಮಾರ್ಗಸೂಚಿಯನ್ನು     ನೀಡಿದ್ದು ,   ಅದರ೦ತೆ   ಉಲ್ಲೇಖ (4)  \n" +
                "            \n"+
                "ರಲ್ಲಿ   ಮಂಜೂರಾತಿ     ನೀಡಲು      ಅಧಿಕಾರ    ಪ್ರತ್ಯಾಯೋಜಿಸಲಾಗಿದೆ.   ಪ್ರಯುಕ್ತ      ರೇಷ್ಮೆ     ಗೂಡಿನ     ಮಾರುಕಟ್ಟೆ , \n" +
                "            \n"+
                apiResponse.getContent().get(0).getUserMarket() + "    ಸ೦ಸ್ಮೆಯಲ್ಲಿ     ದಿನಾ೦ಕ: "+formattedDate1 + "  ರ   ಮಾಹೆಯಲ್ಲಿ      ವಹಿವಾಟಾದ\n " +
                "      \n " +
                "ಬಿತ್ತನೆ     ಗೂಡುಗಳಿಗೆ    ಪ್ರೋತ್ಸಾಹಧನದ  ವಿವರ    ಕೆಳಗಿನಂತಿದೆ.");
        Float amountFloat = apiResponse.getContent().get(0).getTotalSchemeAmount();
        long amountLong = amountFloat.longValue();

        String amountInWords = KannadaNumberUtil.convertNumberToKannadaWords(amountLong);
        response.setHeader5("              ಉಲ್ಲೇಖ (1)  ಮತ್ತು    (2) ರ    ಸೂತ್ತೋಲೆಗಳಲ್ಲಿ     ಸೂಚಿಸಿರುವ    ಅರ್ಹತಾ    ಅ೦ಶಗಳನ್ನು      ಪರಿಶೀಲಿಸಿ    ರೂ. " +apiResponse.getContent().get(0).getTotalSchemeAmount() + "/- \n" +
                "            \n"+
                "(ರೂಪಾಯಿ  " +amountInWords +"  ರೂಗಳು ಮಾತ್ರ  )ಗಳಿಗೆ    ಪ್ರೋತ್ಸಾಹ  ಧನವನ್ನು     ಪಟ್ಟೆಯಲ್ಲಿ \n" +
                "            \n"+
                "ಲಗತ್ತಿಸಿರುವ    02   ಜನರ   ರೇಷ್ಮೆ    ಬೆಳೆಗಾರರ    ಹೆಸರಿನಲ್ಲಿ     ಮ೦ಜೂರು    ಮಾಡಬಹುದಾಗಿರುತ್ತದೆ.   ಉಲ್ಲೇಖ (4) ರಂತೆ\n"+
                "                 \n"+
                "ಕೆಳಸಹಿದಾರರಿಗೆ   ಅಧಿಕಾರ    ಪ್ರಾಪ್ತವಿದ್ದು     ಕೆಳಕ೦ಡ೦ತೆ   ಮ೦ಜೂರಾತಿ   ನೀಡಲಾಗಿದೆ.");
        ...
        response.setHeader7("            ಪ್ರಸ್ತಾವನೆಯಲ್ಲಿ    ವಿವರಿಸಿರುವ೦ತೆ    ಸರ್ಕಾರಿ   ರೇಷ್ಮೆ   ಗೂಡಿನ   ಮಾರುಕಟ್ಟೆ,   " +apiResponse.getContent().get(0).getUserMarket() + "\n" +
                "            \n"+
                "ಸ೦ಸ್ಮೆಯಲ್ಲಿ     ಮೇಲ್ಕಂಡ    02   ಜನ    ಮೈಸೂರು    ಬಿತ್ತನೆ   ತಳಿ    ರೇಷ್ಮೆ  ಬೆಳೆಗಾರರಿಗೆ   " +apiResponse.getContent().get(0).getCocoonsWeight() + "  ಕ.ಜಿ.   ಬಿತ್ತನೆ    ಗೂಡುಗಳಿಗೆ    ಕ.ಜಿ.    ಒ೦ದಕ್ಕೆ \n" +
                "            \n"+
                "ರೂ.   " +apiResponse.getContent().get(0).getPerKgRate() + "/-    ರಂತೆ     ಒಟ್ಟು     ರೂ. " +apiResponse.getContent().get(0).getTotalSchemeAmount() + " /-    (ರೂಪಾಯಿ   " + amountInWords +"  ರೂಗಳು   ಮಾತ್ರ  )\n" +
                "            \n"+
                "ಗಳಿಗೆ     ಮ೦ಜೂರು   ಮಾಡಿದೆ     ಸದರಿ     ವೆಚ್ಚವನ್ನು      ಬೆಲೆ     ಸ್ಮಿರೀಕರಣ    ನಿಧಿ    ಅನುದಾನದ   ಯೋಜನೆ    ಲೆಕ್ಕ      ಶೀರ್ಷಿಕೆ \n " +
                        "       \n " +
...
//        sanctionOrderResponseList.add(response);
        ...
        float totalCocoonWeight = 0f;   // ⬅ Added
        ...
        if (apiResponse.getContent()!= null) {
            ...
            for(SanctionOrderResponse sanctionOrderResponse : apiResponse.getContent()){
                ...
                totalCocoonWeight += sanctionOrderResponse.getCocoonsWeight();  // ⬅ Added
        ...
        response.setTotalCocoonsWeights(totalCocoonWeight);
...
//        String amountInWords = NumberToWordsConverter.convert(amountLong);
        ...
        response.setHeader5(apiResponse.getContent().get(0).getFinancialYear() + "  ನೇ   ಸಾಲಿನಲ್ಲಿ    “"+apiResponse.getContent().get(0).getSchemeNameInKannada()+"” "+apiResponse.getContent().get(0).getScCategoryName()+"\n" +
                ...
                "      \n"+
                "  ಬಿಚ್ಚಾ ಣಿಕೆದಾರರು  ತಮ್ಮ  ರೀಲಿಂಗ್  ಘಟಕದಲ್ಲಿ    ಉತ್ಪಾ ದಿಸಿದ   "+apiResponse.getContent().get(0).getRaceName()+"  ಕಚ್ಚಾ   ರೇಷ್ಮೆ ಗೆ    ಪ್ರೋತ್ಸಾಹಧನ  ಮಂಜೂರಾತಿ  ನೀಡುವ  ಕುರಿತು.");
...
//                }
    ...
    private JRBeanCollectionDataSource getDataSourceForPsfaReelingShed(CheckInspectionStatusRequest requestDto)
        ...
        response.setHeader5(apiResponse.getContent().get(0).getFinancialYear() + "   ನೇ   ಸಾಲಿನ   “" + apiResponse.getContent().get(0).getSchemeNameInKannada()+ "”     " + apiResponse.getContent().get(0).getScCategoryName()+"\n\n"
                        + "ವರ್ಗಕ್ಕೆ      ಸೇರಿದ    ಶ್ರೀ./ಶ್ರೀಮತಿ.   " +apiResponse.getContent().get(0).getReelerName()+ "(" +apiResponse.getContent().get(0).getFruitsId()+")   ಬಿನ್/ಕೋಂ  "+apiResponse.getContent().get(0).getReelerFatherName()+  "    "+apiResponse.getContent().get(0).getVillageName()+ "  ,\n\n" +
                apiResponse.getContent().get(0).getHobliName()+ " ,  ಹೋಬಳಿ,   " +apiResponse.getContent().get(0).getTalukName()+ "  ತಾ.   " +apiResponse.getContent().get(0).getDistrictName()+ "   ಇವರು    ನಿರ್ಮಿಸಿರುವ   ರೀಲಿಂಗ್   ಶೆಡ್ಗೆ    ಸಹಾಯಧನ    ಮಂಜೂರು\n\n"
                +"ಮಾಡುವ    ಬಗ್ಗೆ.");
        ...
        response.setHeader1(
                        ...
                        + "     ಸಂಖ್ಯೆ   :  "+apiResponse.getContent().get(0).getSReleaseNo() +"   ದಿನಾಂಕ  :   " +sReleaseDate  + "\n\n"
                        + "6. ರೇಷ್ಮೆ   ಉಪ  ನಿರ್ದೇಶಕರು,  ಸರ್ಕಾರಿ  ರೇಷ್ಮೆ     ಗೂಡಿನ    ಮಾರುಕಟ್ಟೆ,    ಕೊಳ್ಳೇಗಾಲ    ಇವರ   ಪ್ರಸ್ತಾವನೆ    ದಿನಾಂಕ :  "+proposalDate+"");



        response.setHeader6("              " + apiResponse.getContent().get(0).getFinancialYear() + "     ನೇ     ಸಾಲಿನಲ್ಲಿ     ರೇಷ್ಮೆ      ಇಲಾಖೆಯ     ವಿವಿಧ     ಕಾರ್ಯಕ್ರಮಗಳ   ಅನುಷ್ಠಾನಕ್ಕಾಗಿ    ವಿವಿಧ   ಲೆಕ್ಕ \n\n"
                +"ಶೀರ್ಷಿಕೆಗಳಡಿ     ಉಲ್ಲೇಖ     (1)     ರಲ್ಲಿ     ಸರ್ಕಾರವು     ಆಡಳಿತಾತ್ಮಕ     ಅನುಮೋದನೆಯನ್ನು     ನೀಡಿದ್ದು,     ಉಲ್ಲೇಖ(2)ರಲ್ಲಿ \n\n"
                +"ರೀಲಿಂಗ್‌     ಶೆಡ್‌     ನಿರ್ಮಾಣ   ಕಾರ್ಯಕ್ರಮದ     ಅನುಷ್ಠಾನಕ್ಕಾಗಿ     ಮಾರ್ಗಸೂಚಿಯನ್ನು     ನೀಡಲಾಗಿದೆ.     ಇಲಾಖೆಯು\n\n"
                +"“"+ apiResponse.getContent().get(0).getSchemeNameInKannada() +"”   "+ apiResponse.getContent().get(0).getScCategoryName() +"   ಅಡಿ   ರೀಲಿಂಗ್   ಶೆಡ್ \n\n"
                +"ನಿರ್ಮಾಣಕ್ಕೆ     ನಿಗದಿಪಡಿಸಿದ     ಘಟಕ     ದರ /ಸಹಾಯಧನದ     ವಿವರ     ಇಂತಿದೆ;");


        response.setHeader7("ಶ್ರೀ./ಶ್ರೀಮತಿ.    " +apiResponse.getContent().get(0).getReelerName()+ "(" +apiResponse.getContent().get(0).getFruitsId()+")   ಬಿನ್/ಕೋಂ  "+apiResponse.getContent().get(0).getReelerFatherName()+" ,  " +apiResponse.getContent().get(0).getVillageName()+ " ,   "+ apiResponse.getContent().get(0).getHobliName()+ " ,  ಹೋಬಳಿ, "+ apiResponse.getContent().get(0).getTalukName()+ "\n\n"
                              +"ತಾ.  "+apiResponse.getContent().get(0).getDistrictName()+"   ಜಿಲ್ಲೆ     ಇವರು    "+apiResponse.getContent().get(0).getFinancialYear()+ "    ನೇ     ಸಾಲಿಗೆ     ಉಲ್ಲೇಖ (3)   ರನ್ವಯ     ರೀಲಿಂಗ್     ಶೆಡ್   ನಿರ್ಮಾಣದ \n\n"
                            +"ಆಯ್ಕೆಗೊಂಡ     ಫಲಾನುಭವಿಯಾಗಿರುತ್ತಾರೆ    (ಆಯ್ಕೆ     ಪಟ್ಟಿ     ಕ್ರಮ     ಸಂ.25,  ಕೊಳ್ಳೇಗಾಲ     ವ್ಯಾಪ್ತಿಯಲ್ಲಿ     ಸಂಖ್ಯೆ     4  ಸದರಿಯವರು\n\n"
                            +apiResponse.getContent().get(0).getDistrictName()+ "   ಜಿಲ್ಲೆ     "+apiResponse.getContent().get(0).getTalukName()+ "   ತಾಲ್ಲೂಕು,     "+apiResponse.getContent().get(0).getTalukName()+ "    ಗ್ರಾಮದ     ಸ್ವತ್ತಿನ     ಸಂಖ್ಯೆ:344 ರ    9.144ಮೀX12.192ಮೀ=111.48\n\n"
                            +"ಚ.ಮೀಟರ್     ನಿವೇಶನದಲ್ಲಿ     30’X31’=930   ಚದರ     ಅಡಿಗಳ     ರೀಲಿಂಗ್     ಶೆಡ್     ನಿರ್ಮಿಸಿದ್ದು,     ಇವರು     36     ಕೊನೆಗಳ  "+ apiResponse.getContent().get(0).getNumberOfBasins()+"\n\n"
                            +"ಬೇಸಿನ್    ಸುಧಾರಿತ   "+ apiResponse.getContent().get(0).getMachineTypeName()+"  ರೀಲಿಂಗ್    ಯಂತ್ರೋಪಕರಣ     ಅಳವಡಿಸಿರುತ್ತಾರೆ.\n\n"
                            +"ಹಾಗೂ   ಸದರಿಯವರು     ಚಾಲ್ತಿಯಲ್ಲಿರುವ   ರೀಲಿಂಗ್    ರಹದಾರಿ     (ಸಂಖ್ಯೆ    "+ apiResponse.getContent().get(0).getReelingLicenseNumber()+" )   ಅನ್ನು     ಹೊಂದಿರುತ್ತಾರೆ     ಸದರಿಯವರು   900\n\n"
                            +"ಚದರ   ಅಡಿ   ನಿರ್ಮಾಣದ   ರೀಲೀಂಗ್    ಶೆಡ್ ಗೆ    ಸಹಾಯಧನ     ಪಡೆಯಲು    ಅರ್ಹರಿದ್ದು,     ನಿರ್ಮಿಸಿರುವ    930   ಚ.ಅಡಿಗಳ\n\n"
                            +"ರೀಲಿಂಗ್   ಶೆಡ್   ಅನ್ನು     900   ಚ.ಅಡಿಗಳಿಗೆ     ಸೀಮಿತಗೊಳಿಸಿ,     ಘಟಕ     ದರ     ರೂ.    " + apiResponse.getContent().get(0).getUnitCost()+"/-    ಗಳ     ಶೇಕಡಾ   50ರ  ಸಹಾಯಧನ\n\n"
                            +"ರೂ."+ apiResponse.getContent().get(0).getSubsidyAmount()+"/-  ಗಳನ್ನು     ಮಂಜೂರುಮಾಡುವಂತೆ     ರೇಷ್ಮೆ     ವಿಸ್ತರಣಾಧಿಕಾರಿಗಳು,   ತಾಂತ್ರಿಕ   ಸೇವಾ   ಕೇಂದ್ರ    (ರೀ),  "+ apiResponse.getContent().get(0).getLoggedinUserTscName()+"\n\n"
                            +"ಇವರು     ಸಲ್ಲಿಸಿರುವ     ಪ್ರಸ್ತಾವನೆಯು   ರೇಷ್ಮೆ     ಸಹಾಯಕ     ನಿರ್ದೇಶಕರು,     ಗೂ.ನಂ.ಚ.    "+ apiResponse.getContent().get(0).getLoggedinUserTalukName()+"     ರೇಷ್ಮೆ     ಉಪ     ನಿರ್ದೇಶಕರು,\n\n"
                            +"ರೇ.ಗೂ.ಮಾ.  "+ apiResponse.getContent().get(0).getLoggedinUserDistrictName()+"     ಇವರಿಂದ     ಉಲ್ಲೇಖ(5)ರಲ್ಲಿ     ಶಿಫಾರಸ್ಸುಗೊಂಡಿರುತ್ತದೆ.\n\n"+

                             "ಈ     ಪ್ರಸ್ತಾವನೆಯನ್ನು     ಉಲ್ಲೇಖ(2)ರ     ಮಾರ್ಗಸೂಚಿಯನ್ವಯ     ಪರಿಶೀಲಿಸಲಾಗಿದ್ದು,     ಎಲ್ಲಾ     ಅಗತ್ಯ     ದಾಖಲಾತಿಗಳನ್ನು \n\n"
                             +"ಒಳಗೊಂಡಿರುತ್ತದೆ.     ಆದ್ದರಿಂದ,    ಶ್ರೀ./ಶ್ರೀಮತಿ.    " +apiResponse.getContent().get(0).getReelerName()+ "(" +apiResponse.getContent().get(0).getFruitsId()+")    ಬಿನ್/ಕೋಂ  "+apiResponse.getContent().get(0).getReelerFatherName()+ ",\n\n"
                              +apiResponse.getContent().get(0).getVillageName()+ " ,   "+ apiResponse.getContent().get(0).getHobliName()+ " ,  ಹೋಬಳಿ,   " +apiResponse.getContent().get(0).getTalukName()+ "    ತಾ.     "+apiResponse.getContent().get(0).getDistrictName()+ "   ಇವರಿಗೆ   900     ಚದರ     ಅಡಿಗಳ     ರೀಲಿಂಗ್     ಶೆಡ್ \n\n"
                             +"ನಿರ್ಮಾಣಕ್ಕೆ     ಸಹಾಯಧನ     ಮಂಜೂರು     ಮಾಡಬಹುದಾಗಿದೆ.     ಅದರಂತೆ     ಈ     ಆದೇಶ.");
        ...
        response.setHeader9("         ಪೀಠಿಕೆಯಲ್ಲಿ       ವಿವರಿಸಿದಂತೆ,     "+ apiResponse.getContent().get(0).getFinancialYear() + "     ನೇ     ಸಾಲಿನ     “"+ apiResponse.getContent().get(0).getSchemeNameInKannada()+"”   \n\n" +
                apiResponse.getContent().get(0).getScCategoryName()+ "    ಅಡಿ    900   ಚ.ಅಡಿ   ರೀಲಿಂಗ್  ಶೆಡ್    ನಿರ್ಮಾಣಕ್ಕೆ    ಉಲ್ಲೇಖ(3)ರ    ವಿತ್ತೀಯ    ಪ್ರತ್ಯಾಧಿಕಾರದನ್ವಯ\n\n"
                +"ಫಲಾನುಭವಿಗಳ    ಆಧಾರಿತ    ಕಾರ್ಯಕ್ರಮಗಳಿಗೆ    ಸಹಾಯಧನ   ಮಂಜೂರು   ಮಾಡಲು  ರೇಷ್ಮೆ    ಜಂಟಿ   ನಿರ್ದೇಶಕರು,  "+ apiResponse.getContent().get(0).getDivisionName()+"\n\n"
                +"ವಿಭಾಗ,     "+ apiResponse.getContent().get(0).getLoggedinUserDistrictName()+"  ರವರಿಗೆ   ಪೂರ್ಣ   ಅಧಿಕಾರವಿದ್ದು,   ಈ   ಕೆಳಗೆ    ವಿವರಿಸಿದಂತೆ    ಮಂಜೂರಾತಿ   ನೀಡಿದೆ. ");

        response.setHeader10("(ರೂ. ಎರಡು ಲಕ್ಷ ಎಪ್ಪತ್ತು ಸಾವಿರ ಮಾತ್ರ)    \n\n"+
                        "              ಸದರಿ    ಮೊತ್ತವನ್ನು    “"+ apiResponse.getContent().get(0).getSchemeNameInKannada() +"” "+ apiResponse.getContent().get(0).getScCategoryName() +" \n\n" +
                        "ಲೆಕ್ಕ     ಶೀರ್ಷಿಕೆ:  "+ apiResponse.getContent().get(0).getScHeadAccountName() +"   ಯೋಜನೆ   ಅಡಿಯಲ್ಲಿ    ಭರಿಸುವುದು.    ಖಜಾನೆ-2 ರಲ್ಲಿ     ಸಹಾಯಧನದ   ಮೊತ್ತವನ್ನು \n\n"
    ...
    private JRBeanCollectionDataSource getDataSourceForPsfaHRU(CheckInspectionStatusRequest requestDto)
        ...
        response.setHeader6(apiResponse.getContent().get(0).getFinancialYear() + "  ನೇ   ಸಾಲಿನಲ್ಲಿ     ಉಲ್ಲೇಖ(1)ರ    ಸರ್ಕಾರಿ   ಆದೇಶ  ಹಾಗೂ    ಉಲ್ಲೇಖ(2)ರ    ಮೂಲಕ   ರೇಷ್ಮೆ     ಕೃಷಿ    ಅಭಿವೃದ್ದಿ     ಆಯುಕ್ತರು\n\n"
                        + "ಹಾಗೂ    ರೇಷ್ಮೆ    ನಿರ್ದೇಶಕರು,   "+ apiResponse.getContent().get(0).getLoggedinUserDistrictName() +"   ರವರು     "+  apiResponse.getContent().get(0).getSchemeNameInKannada() + "”  "
                        + apiResponse.getContent().get(0).getScCategoryName()
                        + "  ಅಡಿ  ರೇಷ್ಮೆ  ನೂಲು  ಬಿಚ್ಚಾಣಿಕೆದಾರರು  ತಮ್ಮ  ರೀಲಿಂಗ್  ಘಟಕದಲ್ಲಿ\n\n"
                        + "ಹೀಟ್  ರಿಕವರಿ  ಯೂನಿಟ್  ಅಳವಡಿಕೆಗೆ  ಘಟಕ  ದರ  ರೂ. "
                        + formatAmount(apiResponse.getContent().get(0).getUnitCost())
                        + "/-  ಗಳಿಗೆ  ಶೇ. "
                        + formatAmount(apiResponse.getContent().get(0).getUnitCost())     // 75 – adjust getter name
                        + "  ರಂತೆ  ರೂ. "
                        + formatAmount(apiResponse.getContent().get(0).getSubsidyAmount())
                        + "/-  ಸಹಾಯಧನ  ನೀಡುವ  ಕಾರ್ಯಕ್ರಮವನ್ನು  ಅನುಷ್ಠಾನಗೊಳಿಸಲು  ಮಾರ್ಗಸೂಚಿಯನ್ನು  ನೀಡಲಾಗಿದೆ.\n\n"
                        + "ಉಲ್ಲೇಖ  (5)  ರ  ಮೂಲಕ  ಮೇಲ್ಕಂಡ  ಯೋಜನೆಯಡಿ  ಅನುದಾನವನ್ನು  ಬಿಡುಗಡೆ  ಮಾಡಲಾಗಿದೆ."
        );
        ...
        response.setHeader7(
                "ಶ್ರೀ./ಶ್ರೀಮತಿ.  " + apiResponse.getContent().get(0).getReelerName() + " (" + apiResponse.getContent().get(0).getFruitsId() + ")  ಬಿನ್/ಕೋಂ  "
                        ...
                        + apiResponse.getContent().get(0).getDistrictName() + "  ಜಿಲ್ಲೆ  ಇವರು  "
                        + apiResponse.getContent().get(0).getScCategoryName()
                        + "  ವರ್ಗಕ್ಕೆ  ಸೇರಿದವರಾಗಿದ್ದು,\n\n"
                        + "ರಿೀಲಿಂಗ್  ರಹದಾರಿ  ಸಂಖ್ಯೆ  "
                        + apiResponse.getContent().get(0).getReelingLicenseNumber()
                        + "  ರಲ್ಲಿ  0" + apiResponse.getContent().get(0).getNumberOfBasins()
                        + "  ಬೇಸಿನ್  "
                        + apiResponse.getContent().get(0).getMachineTypeName()
                        + "  ರೀಲಿಂಗ್  ಘಟಕ  ಹೊಂದಿರುತ್ತಾರೆ.\n\n"
                        + apiResponse.getContent().get(0).getFinancialYear()
                        + "  ನೇ  ಸಾಲಿಗೆ  ಉಲ್ಲೇಖ  (3)  ರನ್ವಯ  ಹೀಟ್  ರಿಕವರಿ  ಯೂನಿಟ್  ಅಳವಡಿಸಲು  ಆಯ್ಕೆಗೊಂಡ  ಫಲಾನುಭವಿಯಾಗಿರುತ್ತಾರೆ\n\n"
                        + "(ಆಯ್ಕೆ  ಪಟ್ಟಿ  ಕ್ರಮ  ಸಂ. "
                        + apiResponse.getContent().get(0).getUnitCost()
                        + ",  "
                        + apiResponse.getContent().get(0).getLoggedinUserTalukName()
                        + "  ವ್ಯಾಪ್ತಿಯಲ್ಲಿ  ಸಂಖ್ಯೆ  "
                        + apiResponse.getContent().get(0).getUnitCost()
                        + ").\n\n"
                        + "ತಮ  ರೀಲಿಂಗ್  ಘಟಕದಲ್ಲಿ  "
                        + apiResponse.getContent().get(0).getUnitCost()
                        + "  ಸಂಸ್ಥೆಯ  ಮೂಲಕ  ಟ್ಯಾಕ್ಸ್  ಇನ್‌ವಾಯ್ಸ್  ಸಂಖ್ಯೆ  "
                        + apiResponse.getContent().get(0).getUnitCost()
                        + "  ದಿನಾಂಕ  :  "
                        + formatDate(apiResponse.getContent().get(0).getUnitCost(), sdf)
                        + "  ರಂತೆ  ರೂ. "
                        + formatAmount(apiResponse.getContent().get(0).getUnitCost())
                        + "/-  ವೆಚ್ಚದಲ್ಲಿ  ಹೀಟ್  ರಿಕವರಿ  ಯೂನಿಟ್  ಖರೀದಿಸಿ  ಅಳವಡಿಸಿಕೊಂಡಿರುತ್ತಾರೆ.\n\n"
                        + "ಸಹಾಯಧನ  ಮಂಜೂರಾತಿಗಾಗಿ  ಅಗತ್ಯ  ದಾಖಲೆಗಳನ್ನು  ಸೇರಿಸಿ  ಸಲ್ಲಿಸಿರುವ  ಪ್ರಸ್ತಾವನೆಯನ್ನು\n\n"
                        + "ಉಲ್ಲೇಖ  (2)  ರ  ಮಾರ್ಗಸೂಚಿಯ  ಅನ್ವಯ  ಪರಿಶೀಲಿಸಿರುವದರಿಂದ,  ಯೋಜನೆಯಡಿ  ಸಹಾಯಧನ\n\n"
                        + "ಪಡೆಯಲು  ಅರ್ಹರಾಗಿದ್ದಾರೆಂದು  ತೋರುತ್ತದೆ."
        );
        ...
        response.setHeader8(
                "ಸಂಖ್ಯೆ  :  ರೇಸನಿ/" + shortDistrictKannada + "/"
                        + apiResponse.getContent().get(0).getLoggedinUserTalukName() + "/"
                        + apiResponse.getContent().get(0).getUnitCost() + "/"
                        + apiResponse.getContent().get(0).getScCategoryName() + "/ಹೀಟ್‌ರಿಕವರಿ-ಯೂನಿಟ್/"
        ...
        response.setHeader9(
                "ಆದೇಶ\n\n"
                        ...
                        + apiResponse.getContent().get(0).getScCategoryName()
                        + "  ಅಡಿ  ರೇಷ್ಮೆ  ನೂಲು  ಬಿಚ್ಚಾಣಿಕೆದಾರರು  ತಮ್ಮ  ರೀಲಿಂಗ್  ಘಟಕದಲ್ಲಿ\n\n"
                        + "ಹೀಟ್  ರಿಕವರಿ  ಯೂನಿಟ್  ಅಳವಡಿಕೆಗೆ  ಉಲ್ಲೇಖ  (4)  ರ  ಮೂಲಕ  ರೇಷ್ಮೆ  ಕೃಷಿ  ಅಭಿವೃದ್ದಿ  ಆಯುಕ್ತರು\n\n"
        ...
        response.setHeader12(
                apiResponse.getContent().get(0).getSchemeNameInKannada()
                        + "  ("
                        + apiResponse.getContent().get(0).getScCategoryName()
                        + ")  ಅಡಿಯಲ್ಲಿ  ಹೀಟ್  ರಿಕವರಿ  ಯೂನಿಟ್  ಅಳವಡಿಕೆಗೆ  ಸಹಾಯಧನ  ಪಡೆಯಲು\n\n"
                        + "ಶ್ರೀ./ಶ್ರೀಮತಿ.  " + apiResponse.getContent().get(0).getReelerName() + " (" + apiResponse.getContent().get(0).getFruitsId() + ")  ಬಿನ್/ಕೋಂ  "
                        + apiResponse.getContent().get(0).getReelerFatherName()
                        + ",  "
                        + apiResponse.getContent().get(0).getVillageName()
    ...
    private String getFirstTwoLetters(String input) {
        ...
        SanctionOrderResponse response = new SanctionOrderResponse();
            ...
            response.setHeader20( "                " + apiResponse.getContent().get(0).getFinancialYear() + "    ನೇ ಸಾಲಿನಲ್ಲಿ    ಇಲಾಖೆಯು  ಕೇಂದ್ರ    ರೇಷ್ಮೆ     ಮಂಡಳಿಯಸಹಯೋಗದೊಂದಿಗೆ   ಅನುಷ್ಟಾ  ನಗೊಳಿಸುತ್ತಿ ರುವ  ಕೇಂದ್ರ\n" +
                    "                    \n" +
                                  "                ವಲಯ   “"+ apiResponse.getContent().get(0).getFinancialYear() +"”   ಯೋಜನೆಯಡಿ    " +apiResponse.getContent().get(0).getScComponentName() + "\n" +
                                  "          \n" +
            ...
            response.setHeader8(  "               " + apiResponse.getContent().get(0).getFinancialYear() +"    ನೇ  ಸಾಲಿನಲ್ಲಿ     ರೇಷ್ಮೆ     ಇಲಾಖೆಯ   ವಿವಿಧ   ಕಾರ್ಯಕ್ರ ಮಗಳ   ಅನುಷ್ಠಾ ನಕ್ಕಾ ಗಿ   ವಿವಿಧ   ಲೆಕ್ಕ     ಶೀರ್ಷಿಕೆಗಳಡಿ   ಉಲ್ಲೇ ಖ(1)ರಲ್ಲಿ     ಸರ್ಕಾರವು\n " +
                    ...
                    "     \n" +
                    "ನೀಡಲಾಗಿದೆ.  ಇಲಾಖೆಯು  ಕೇಂದ್ರ  ರೇಷ್ಮೆ  ಮಂಡಳಿಯ  ಸಹಯೋಗದೊಂದಿಗೆ  ಕೇಂದ್ರ  ವಲಯ  “"+ apiResponse.getContent().get(0).getFinancialYear() +"”  ಯೋಜನೆಯನ್ನು    ಅನುಷ್ಟಾ  ನಗೊಳಿಸಲಾಗುತ್ತಿ ದೆ.\n " +
                    "          \n" +
...
//                    "ಪ್ರ  ತ್ಯಾ ಯೋಜನೆ   ವ್ಯಾ ಪ್ತಿ ಯಲ್ಲಿ ದ್ದು ,  ಉಲ್ಲೇಖ (4)ರಲ್ಲಿ    ಸದರಿ  ಕಾರ್ಯಕ್ರ  ಮದ  ಅನುಷ್ಠಾ  ನಕ್ಕಾ ಗಿ   ನೀಡಿರುವ  ಮಾರ್ಗಸೂಚಿಯನ್ವ ಯ   ಸಹಾಯಧನ   ಮಂಜೂರು   ಮಾಡಲು\n " +
            ...
            response.setHeader16("            ಮೇಲಿನ   ಪೀಠಿಕೆಯಲ್ಲಿ    ವಿವರಿಸಿರುವಂತೆ   ರೇಷ್ಮೆ    ಉಪನಿರ್ದೇಶಕರು,   ಜಿಲ್ಲಾ    ಪಂಚಾಯತ್,   " +apiResponse.getContent().get(0).getLoggedinUserDistrictName() + "    ರವರು   ಶಿಫಾರಸ್ಸು    ಮಾಡಿರುವಂತೆ   " +apiResponse.getContent().get(0).getLoggedinUserTscName() + "\n " +
                    ...
                    "               \n " +
                    apiResponse.getContent().get(0).getFatherNameKan() + "  ರವರು   ಕೇಂದ್ರ    ವಲಯ   “"+ apiResponse.getContent().get(0).getFinancialYear() +"”    ಯೋಜನೆಯಡಿ   " +apiResponse.getContent().get(0).getRhSqft() + "   ಚದರಡಿ    ರೇಷ್ಮೆ    ಹುಳು    ಸಾಕಾಣಿಕೆ   ಮನೆಗೆ   ಘಟಕ    ದರದ   ಶೇಕಡ\n " +
                    "      \n " +
    ...
    "     \n" +
                    "ಮತ್ತು   ರಾಜ್ಯ ದ   ಪಾಲಾಗಿ  ರೂ.  " +stateShareAmount   + "/-  (  ರೂ. " +stateShareWords + "   ) ಗಳನ್ನು    ರಾಜ್ಯ    "+apiResponse.getContent().get(0).getSchemeNameInKannada() +"   ಯೋಜನೆಯ  ಲೆಕ್ಕ \n " +
            "      \n " +
...
// ಪೀಠಿಕೆ
        response.setHeader4(
                apiResponse.getContent().get(0).getFinancialYear()
                        ...
                        +"ರೂ."+ apiResponse.getContent().get(0).getUnitCost() +"/-ಗಳಲ್ಲಿ   ಶೇ.50  ರಂತೆ   ರೂ."+ apiResponse.getContent().get(0).getSubsidyAmount() +"/-ಗಳ   ಚಾಕಿ  ಸೇವಾ   ಶುಲ್ಕವನ್ನು    ನೀಡುವ   ಕಾರ್ಯಕ್ರಮವಿರುತ್ತದೆ. \n\n"
        ...
        response.setHeader6(
                "ಪ್ರಸ್ತಾವನೆಯನ್ನು     ಪರಿಶೀಲಿಸಲಾಗಿ     ಮೇಲ್ಕಂಡ     ರೇಷ್ಮೆ     ಬೆಳೆಗಾರರು     ನೋಂದಾಯಿತ     ಶುದ್ಧ     ಮೈಸೂರು     ತಳಿ     ಚಾಕಿ     ಸಾಕಾಣಿಕಾ \n\n"
                        ...
                        +"ವೆಚ್ಚ     ರೂ."+ apiResponse.getContent().get(0).getUnitCost() +"/-ಗಳ   ಚಾಕಿ   ಸೇವಾ   ಶುಲ್ಕ,   ಒಟ್ಟು   ರೂ. "+ apiResponse.getContent().get(0).getSubsidyAmount() +" /- ಗಳನ್ನು    ಚಾಕಿ   ಸೇವಾ   ಶುಲ್ಕ,   ಒಟ್ಟು   ರೂ. " + totalSubsidyAmountCa+" /- ಗಳನ್ನು     ಪಡೆಯಲು  \n\n"
...
// Detailed sanction – final justification paragraph
//        response.setHeader8(
//                "ಪ್ರಸ್ತಾವನೆಯಲ್ಲಿ     ವಿವರಿಸಿರುವಂತೆ     ಈ     ಕಛೇರಿಗೆ     ಸಲ್ಲಿಸಿರುವ     ಪ್ರಸ್ತಾವನೆಯನ್ನು     ಪರಿಗಣಿಸಿ, "+ apiResponse.getContent().get(0).getUserMarket() + "     ತಾಂತ್ರಿಕ     ಸೇವಾ     ಕೇಂದ್ರದ\n\n"
//                        +"ವ್ಯಾಪ್ತಿಯ     ಶುದ್ಧ     ಮೈಸೂರು     ತಳಿ     ರೇಷ್ಮೆ     ಬೆಳೆಗಾರರು,     ಅನುಬಂಧದಲ್ಲಿ     ತೋರಿಸಿರುವಂತೆ     ಚಾಕಿ     ಸಾಕಾಣಿಕಾ     ಕೇಂದ್ರಗಳಿಂದ     ಖರೀದಿಸಿರುವ     ಒಟ್ಟು     " + totalDfls.intValue() + "     ಶುದ್ಧ     ಮೈಸೂರು     ತಳಿ \n\n"
//                        + "ರೇಷ್ಮೆ     ಮೊಟ್ಟೆಗಳಿಗೆ,   ಪ್ರತಿ     100     ಮೊಟ್ಟೆಗೆ     ರೂ.     " + unitCost + "/-     ರಂತೆ     ಒಟ್ಟು     ರೂ.     " + totalSubsidyAmount + "     (ರೂಪಾಯಿ     " + amountInWords +"\n\n"
//                        + "     ಮಾತ್ರ)ಗಳ     ಚಾಕಿ     ಸೇವಾ     ಶುಲ್ಕವನ್ನು     ಮಂಜೂರು     ಮಾಡಲಾಗಿದೆ. \n\n"
//                        + "ಸದರಿ     ವೆಚ್ಚವನ್ನು     "+apiResponse.getContent().get(0).getSchemeNameInKannada() +"    ಯೋಜನೆಯ     ಲೆಕ್ಕ     ಶೀರ್ಷಿಕೆ     " + apiResponse.getContent().get(0).getScHeadAccountName() + "     ಅಡಿ     ಖಜಾನೆ-2     ರಲ್ಲಿ     ಬಿಡುಗಡೆಗೊಂಡಿರುವ     ಅನುದಾನದಿಂದ     ಡಿ.ಬಿ.ಟಿ     ಮುಖಾಂತರ     ಫಲಾನುಭವಿಗಳ     ಖಾತೆಗೆ     ನೇರವಾಗಿ     ಜಮಾ     ಮಾಡಬೇಕು. \n"
//        );
        ...
        response.setHeader8("ಪೀ ಠಿಕೆಯಲ್ಲಿ      ವಿವರಿಸಿರುವ     ಎಲ್ಲಾ     ಅಂ ಶಗಳನ್ನು     ಪರಶೀ ಲಿಸಲಾಗಿ,      "+ apiResponse.getContent().get(0).getLoggedinUserTalukName() + "   ತಾಲ್ಲೂ ಕಿನ    ತಾಂತ್ರಿ ಕ    ಸೇ ವಾ    ಕೇಂ ದ್ರ   \n " +
                ...
                +"ರೂ."+ apiResponse.getContent().get(0).getUnitCost() +"/-   ಗಳಲ್ಲಿ    ಶೇ.50ರಂತೆ   ರೂ."+ apiResponse.getContent().get(0).getSubsidyAmount() +"/- ಗಳ     ಚಾಕಿ    ಸೇ ವಾ    ಶುಲ್ಕ    ಒಟ್ಟು    ರೂ. "+ totalSubsidyAmountCa +"/-  ("+amountInWords+" )\n\n"
...
// Accounts / copies block (DD sanction case)
        response.setHeader9(
                "ಈ     ಕಚೇರಿಯ     ಲೆಕ್ಕ     ಶಾಖೆಗೆ     ಮುಂದಿನ     ಕ್ರಮಕ್ಕಾಗಿ. \n\n"
                        + "ಪ್ರತಿಯನ್ನು: \n\n"
                        + "1.     ಸಂಬಂಧ     ಪಟ್ಟ     ಖಜಾನೆ     ಅಧಿಕಾರಿಗಳಿಗೆ \n\n"
                        + "2.     ರೇಷ್ಮೆ     ವಿಸ್ತರಣಾಧಿಕಾರಿಗಳು  /  ಪ್ರಭಾರಾಧಿಕಾರಿಗಳು,   ತಾಂತ್ರಿಕ     ಸೇವಾ     ಕೇಂದ್ರ  \n\n"
...
// even if totalSchemeAmount was null
        ...
        response.setHeader4(
                ...
                +"ಪ್ರತಿ  ಕೆ.ಜಿ    "+apiResponse.getContent().get(0).getRaceName()+"   ರೇಷ್ಮೆ  ಗೂಡಿಗೆ     ರೂ.  "+ apiResponse.getContent().get(0).getUnitCost() + "/-     ರಂತೆ     '"+apiResponse.getContent().get(0).getSubSchemeNameInKannada() +"'     ನೀಡುವ    ಕಾರ್ಯಕ್ರಮದ      ಅನುಷ್ಟಾನಕ್ಕಾಗಿ \n\n"
...
// CHANGED: footer & header should show ACTUAL KG, not units
        ...
        response.setHeader7(
                "    ಪೀಠಿಕೆಯಲ್ಲೆ     ವಿವರಿಸಿರುವ     ಎಲ್ಲಾ     ಅಂಶಗಳನ್ನು     ಪರಿಶೀಲಿಸಲಾಗಿ,     " + apiResponse.getContent().get(0).getLoggedinUserTalukName() + "     ತಾಲ್ಲೂಕಿನ     ತಾಂತ್ರಿಕ     ಸೇವಾ     ಕೇಂದ್ರ     " + apiResponse.getContent().get(0).getLoggedinUserTscName()+"\n\n"
                        ...
                        +"ಗೂಡಿಗೆ     ಪ್ರತಿ     ಕೆ.ಜಿ.ಗೆ     ರೂ. " +  apiResponse.getContent().get(0).getUnitCost() +  "/-     ರಂತೆ   "+apiResponse.getContent().get(0).getSubSchemeNameInKannada()+ "  ರೂ. " +   totalTransportAmount      + "/-     (ರೂಪಾಯಿ     " + totalTransportInWords   + " )\n\n"
        ...
        response.setHeader5(
                "ಪ್ರಸ್ತಾವನೆಯನ್ನು     ಪರಿಶೀಲಿಸಲಾಗಿ     ಮೇಲ್ಕಂಡ     ರೇಷ್ಮೆ     ಬೆಳೆಗಾರರು     ಸರ್ಕಾರಿ     ರೇಷ್ಮೆ     ಗೂಡಿನ   ಮಾರುಕಟ್ಟೆಗಳಲ್ಲಿ     ವಹಿವಾಟು   ಮಾಡಿದ\n\n"
                        +  totalQtyKg + "   ಕೆ.ಜಿ    "+apiResponse.getContent().get(0).getRaceName()+"     ರೇಷ್ಮೆ     ಗೂಡಿಗೆ,     ಪ್ರತಿ     ಕೆ.ಜಿ.ಗೆ     ರೂ. " +  apiResponse.getContent().get(0).getUnitCost() +  "/-  ರಂತೆ  "+apiResponse.getContent().get(0).getSubSchemeNameInKannada()+"   ರೂ. " + totalTransportAmount + "/-     ಗಳನ್ನು     ಪಡೆಯಲು \n\n"
...
//        }
        ...
        response.setHeader4(
                apiResponse.getContent().get(0).getFinancialYear()
                        ...
                        + ""+apiResponse.getContent().get(0).getSchemeNameInKannada() +"    ಯೋಜನೆಯಡಿ     ಉತ್ತರವ     ಕರ್ನಾಟಕದ     ಜಿಲ್ಲೆಗಳಲ್ಲಿ     "+apiResponse.getContent().get(0).getRaceName()+"\n\n"
                        +"ರೇಷ್ಮೆ     ಗೂಡು   ಉತ್ಪಾದನೆಗೆ  ಉತ್ತೇಜನ   ನೀಡುವ   ಸಲುವಾಗಿ,   ರೈತರು   ಉತ್ಪಾದಿಸಿದ     "+apiResponse.getContent().get(0).getRaceName()+ "   ಸಂಕರಣ   ಹಾಗೂ   ಬಿತ್ತನೆ\n\n"
                        +"ರೇಷ್ಮೆ     ಗೂಡನ್ನು     ರಾಜ್ಯದ   ಯಾವುದೇ    ಸರ್ಕಾರಿ     ರೇಷ್ಮೆ     ಗೂಡಿನ     ಮಾರುಕಟ್ಟೆಗಳಲ್ಲಿ     ಮಾರಾಟ     ಮಾಡಲು     ಸಾಗಾಣಿಕೆ \n\n"
                        +" ಮಾಡುವ     ಪ್ರತಿ  ಕೆ.ಜಿ   " +apiResponse.getContent().get(0).getRaceName()+ "  ರೇಷ್ಮೆ   ಗೂಡಿಗೆ     ರೂ.  "+ apiResponse.getContent().get(0).getUnitCost() + "/-     ರಂತೆ     '"+apiResponse.getContent().get(0).getSubSchemeNameInKannada() +"'    ನೀಡುವ \n\n"
        ...
        // ಮಂಜೂರಾತಿ ಆದೇಶ ಸಂಖ್ಯೆ line
        response.setHeader6(
                "ಆದೇಶ     ಸಂಖ್ಯೆ  :     ರೇಸನಿ:" + apiResponse.getContent().get(0).getLoggedinUserTalukName() + " ತಾಂ:ದ್ವಿ.ಚಾ.ಸಾ.ವೆಚ್ಚ:ಸಧನ: SON." + apiResponse.getContent().get(0).getSanctionOrderNumber() + " /  ದಿನಾಂಕ  : " + proposalDate);
...
// NOW: compute in-words using TOTAL KG
        ...
        response.setHeader5(
                "ಪ್ರಸ್ತಾವನೆಯನ್ನು     ಪರಿಶೀಲಿಸಲಾಗಿ     ಮೇಲ್ಕಂಡ     ರೇಷ್ಮೆ     ಬೆಳೆಗಾರರು     ಸರ್ಕಾರಿ     ರೇಷ್ಮೆ     ಗೂಡಿನ   ಮಾರುಕಟ್ಟೆಗಳಲ್ಲಿ     ವಹಿವಾಟು   ಮಾಡಿದ\n\n"
                        +  totalQtyKg + "     ಕೆ.ಜಿ     "+apiResponse.getContent().get(0).getRaceName()+"   ರೇಷ್ಮೆ     ಗೂಡಿಗೆ,     ಪ್ರತಿ     ಕೆ.ಜಿ.ಗೆ     ರೂ. " +  totalIncentiveAmount +  "/-  ರಂತೆ   "+ apiResponse.getContent().get(0).getSubSchemeNameInKannada() +"  ರೂ. " +  apiResponse.getContent().get(0).getUnitCost() + "/-     ಗಳನ್ನು     ಪಡೆಯಲು \n\n"
                        + "ಅರ್ಹರಾಗಿದ್ದಾರೆ.    ಉಲ್ಲೇಖ     (3)     ರ     ಸರ್ಕಾರದ     ಆದೇಶದ     ರೀತ್ಯಾ     ಈ     ಕಛೇರಿಯ     ಅಧಿಕಾರ     ಪ್ರತ್ಯಾಯೋಜನೆ     ವ್ಯಾಪ್ತಿಯಲ್ಲಿದ್ದು,\n\n"
                        +"ಉಲ್ಲೇಖ     (4)     ರಲ್ಲಿ     ನೀಡಿರುವ     ಮಾರ್ಗಸೂಚಿಯನ್ವಯ     ಸಹಾಯಧನ     ಮಂಜೂರು     ಮಾಡಲು     ಅನುದಾನ     ಬಿಡುಗಡೆ     ಮಾಡಲಾಗಿದೆ. \n\n"
                        + "ಅದರಂತೆ     ಈ     ಕೆಳಕಂಡ     ಮಂಜೂರಾತಿ     ಆದೇಶ     ಹೊರಡಿಸಿದೆ. \n"
        );
